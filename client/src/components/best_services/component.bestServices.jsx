...
// importing images
import image1 from "../../assests/image 1.jpeg";
import image2 from "../../assests/image 1 (1).jpeg";
import image3 from "../../assests/image 1 (2).jpeg";
...
const Display = () => {
  const headers = ["Pharmacy", "Printing/Xerox", "Laundry"];

  const paras = [
    "Get upto 50% off on your first booking",
    "Cloured available",
    "All Types of Clothing, All for You",
  ];
